...
Use **Review > Accept All Changes** or **Reject All Changes** to resolve the whole document, including hidden authors, headers, footers, and notes. The operation keeps comments and creates one undo step. If a change cannot be resolved, the editor refuses the operation without partially applying it.
